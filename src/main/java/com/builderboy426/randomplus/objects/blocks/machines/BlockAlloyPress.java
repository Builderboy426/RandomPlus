...
public class BlockAlloyPress extends BlockBase {
	
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public static final PropertyBool BURNING = PropertyBool.create("burning");
	
	public BlockAlloyPress(String name) {
		super(name, Material.IRON, 21.75f);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		player.openGui(Main.instance, Reference.GUI_ALLOY_PRESS, world, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
	...
	public void breakBlock(World world, BlockPos pos, IBlockState state) {
		TileEntityAlloyPress tileEntity = (TileEntityAlloyPress)world.getTileEntity(pos);
	...
	public static void setState(boolean active, World world, BlockPos pos) {
		...
		if (active) { world.setBlockState(pos, BlockInit.ALLOY_PRESS.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, true), 3); }
		else { world.setBlockState(pos, BlockInit.ALLOY_PRESS.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, false), 3); }
